...
export function AdminApp() {
    ...
    const account = async (ev: React.FormEvent<HTMLFormElement>) => { ev.preventDefault(); const el = ev.currentTarget, f = new FormData(el), password = String(f.get('password') || ''); if (password && password.length < 8) {
